<template>
  <section
    class="postion-relative d-flex justify-content-center align-items-top"
    style="height: 100vh; overflow-x: hidden;"
  >
    <h1 class="text-center text-primary fixed-top" ref="title" style="z-index: -2">
      Wanderful<br /><span>Lu's Camping</span>
    </h1>
    <img
      ...
      ref="bird1"
    />
    <img style="margin-top: 10vh" src="@/assets/images/bird2.png" alt="" ref="bird2" />
    <img
      style="margin-top: 10vh; z-index: -1"
      src="@/assets/images/forest.png"
      alt=""
      ref="forest"
    />
    <img style="margin-top: 10vh" src="@/assets/images/rocks.png" alt="" ref="rocks" />
    <img style="margin-top: 10vh" src="@/assets/images/water.png" alt="" ref="water" />
  </section>
  <div class="bg-primary" style="z-index: 1000">
    <h2>sadljefjw</h2>
    <p class="m-0">
...
export default {
  mounted() {
    window.addEventListener('scroll', () => {
      ...
      this.$refs.bird1.style.top = `${value * -1.5}px`;
      this.$refs.bird1.style.left = `${value * 2}px`;
      this.$refs.bird2.style.top = `${value * -1.5}px`;
      this.$refs.bird2.style.left = `${value * -5}px`;
      this.$refs.rocks.style.top = `${value * -0.12}px`;
      this.$refs.forest.style.top = `${value * 0.25}px`;
    });
  },
};
</script>
